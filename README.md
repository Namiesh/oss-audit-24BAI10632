...
## Student Name: Namiesh Gairola
## Roll Number: 24BAI10632
...
**Script 5 - Open Source Manifesto Generator:** An interactive script that prompts the user for three questions about their open-source philosophy and generates a personalized text file (`manifesto\_\[username].txt`).
...
1. **Clone the repository:**
    ```bash
   git clone \[https://github.com/Namiesh/oss-audit-24BAI10632.git](https://github.com/Namiesh/oss-audit-24BAI10632.git)
    ```
    ```bash
   cd oss-audit-24BAI10632
